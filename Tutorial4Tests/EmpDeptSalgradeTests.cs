...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var chicagoDepts = depts.Where(dept => dept.Loc == "CHICAGO").Select(dept => dept.DeptNo).ToList();
        var result = emps.Where(emp => chicagoDepts.Contains(emp.DeptNo)).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps
            ...
            .Select(c => new { DeptNo = c.Key, Count = c.Count() })
            .ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = 
            ...
            select new { emp.EName, emp.Sal, Grade = grade.Grade };    
